...
export default function RandomPlanner() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center gap-4 min-h-[calc(100vh-8rem)] py-8">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-black uppercase text-center px-4">
          Random Travel
        </h2>
        <div className="grid grid-cols-2 md:flex md:flex-row max-w-full gap-3 sm:gap-4 md:gap-8 p-4 overflow-x-auto">
